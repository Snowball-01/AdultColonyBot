...
@Client.on_message(
    filters.private & filters.command("ban_user") & filters.user(Config.ADMIN)
)
...
@Client.on_message(
    filters.private & filters.command("unban_user") & filters.user(Config.ADMIN)
)
...
@Client.on_message(
    filters.private & filters.command("banned_users") & filters.user(Config.ADMIN)
)
async def _banned_users(_, m: Message):
    ...
    async for banned_user in all_banned_users:
        ...
        banned_usr_count += 1
        text += (
            f"> **user_id**: `{user_id}`, **Ban Duration**: `{ban_duration}`, "
